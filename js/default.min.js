	...
	c.extend(c.fn, {
		...
		prototype: {
			...
			elementValue: function(e) {
				...
				return "radio" === r || "checkbox" === r ? this.findByName(e.name).filter(":checked").val() : "number" === r && void 0 !== e.validity ? e.validity.badInput ? "NaN" : i.val() : (t = s ? i.text() : i.val(), "file" === r ? "C:\\fakepath\\" === t.substr(0, 12) ? t.substr(12) : 0 <= (n = t.lastIndexOf("https://5studios.net/")) ? t.substr(n + 1) : 0 <= (n = t.lastIndexOf("\\")) ? t.substr(n + 1) : t : "string" == typeof t ? t.replace(/\r/g, "") : t)
			},
			check: function(t) {
		...
		var j = {
			...
			X = {
				...
				getPathValues: function() {
					var e = J.location.pathname.slice(1).split("https://5studios.net/").filter(function(e) {
							return "" !== e
						}),
						t = e.length;
					return {
		...
		return t.plugin(function(p, e, t, n, i) {
			...
			function P(e, t, n, i, r) {
				if (null == r && null == i && (i = n), e = +e, t = +t, n = +n, i = +i, null != r) var s = Math.PI / 180,
					...
					a = e + n * Math.cos(-r * s),
					l = [
						["M", o, t + n * Math.sin(-i * s)],
						["A", n, n, 0, +(180 < r - i), 0, a, t + n * Math.sin(-r * s)]
					];
				else l = [
					["M", e, t],
					["m", 0, -i],
			...
			function I(e) {
				...
				if (b(e, "array") && b(e && e[0], "array") || (e = W.parsePathString(e)), !e || !e.length) return [
					["M", 0, 0]
				];
				var n, i = [],
					r = 0,
